...
final class ListCompaniesHandlerTest extends TestCase
{
    ...
    public function testSecondPageReturnsRemainder(): void
    {
        ...
        self::assertCount(1, $result->companies);
        self::assertSame('Gamma', $result->companies[0]->name->value);
    }
    ...
    public function testResultsAreOrderedAlphabetically(): void
    {
        ...
        $result = $this->handler->handle(new ListCompanies());
        $names  = array_map(static fn($c) => $c->name->value, $result->companies);
    ...
    {
        $this->create('Alpha Corp');
        $this->create('Alpha Industries');
        $this->create('Beta Ltd');
    ...
    {
        $this->create('Alpha Corp');
        $this->create('Gamma Corp');
        $this->create('Beta Corp');
        ...
        $names = array_map(static fn($c) => $c->name->value, $result->companies);
        self::assertSame(['Gamma Corp', 'Beta Corp', 'Alpha Corp'], $names);
    }
    ...
    public function testEmailFilterReturnsMatchingCompanies(): void
    {
        ...
        self::assertCount(1, $result->companies);
        self::assertSame('Alpha', $result->companies[0]->name->value);
    }
    ...
    public function testCombinedFiltersNarrowResults(): void
    {
        ...
        self::assertCount(1, $result->companies);
        self::assertSame('Alpha France', $result->companies[0]->name->value);
    }
